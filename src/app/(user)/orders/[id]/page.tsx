    ...
    return (
        <div className="flex flex-col-reverse flex-wrap justify-between pt-12 sm:flex-row gap-11 sm:gap-8">
            ...
            <div className='h-full grow sm:basis-800 sm:sticky top-8'>
                <div className='mb-10'>
                    <h3 className={detailsH3Styles}>Order Details</h3>
                    <div className={bxInfoStyles}><span>Order Number</span> <span><Skeleton className="h-5 w-[120px]" /></span></div>
                    <div className={bxInfoStyles}><span>Order Date</span> <span><Skeleton className="h-5 w-[100px]" /></span></div>
                    <div className={bxInfoStyles}><span>Expected Delivery Date</span> <span><Skeleton className="h-5 w-[100px]" /></span></div>
                </div>
                <div className='pt-10 mb-10 border-t border-solid border-border-primary'>
                    <h3 className={detailsH3Styles}>Delivery Address</h3>
                    <ul>
