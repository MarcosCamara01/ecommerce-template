        ...
        return (
          <div className="product-card" key={product._id}>
            ...
            <div className="product-information">
              ...
              {!product.purchased && <div className="product-price">{product?.quantity ? (product.price * product.quantity).toFixed(2) : product.price}€</div>}
              {product.quantity !== undefined && <ProductCartInfo product={product} />}
            </div>
          </div>
        );
      })}
