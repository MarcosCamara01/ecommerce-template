...
export const Navbar = (
  ...
  const cartLinks = (
    <div className='flex gap-2'>
      <li className='flex items-center justify-center'>
        <Link href="/cart" className='text-sm py-3 px-3 rounded-md transition-all text-[#EDEDED] hover:bg-[#1F1F1F] relative'>
      ...
      <li className='flex items-center justify-center'>
        <Link href="/wishlist" className='text-sm py-3 px-3 rounded-md transition-all text-[#EDEDED] hover:bg-[#1F1F1F] relative'>
          <svg
  ...
  return (
    <header className="w-full px-3.5 gap-4 xs:px-6 sm:px-12 py-6 flex items-center justify-between bg-background-secondary border-b border-solid border-border-primary">
      {isMobile ? (
        <>
          <button
            onClick={() => {
